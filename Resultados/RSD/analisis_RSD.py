...
np.savetxt('Betas_RSD.txt',BETAS)
numeros=[]
for i in range(20):
    if i<10:
...
np.savetxt('meancomp_RSD.txt', ComRSD)
np.savetxt('meancomp_NoRSD.txt', ComNoRSD)
np.savetxt('sigmacomp_RSD.txt', SigmaRSD)
np.savetxt('sigmacomp_NoRSD.txt', SigmaNoRSD)
